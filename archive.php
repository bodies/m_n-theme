<?php get_header(); ?>
	...
	<?php /* If this is a category archive */ if (is_category()) { ?>
			<p class="string"><?php _e('Archived posts in ','m_n'); ?>' "<strong><?php echo single_cat_title(); ?></strong>"</p>
			<a href="<?php echo get_option('home'); ?>/" class="back"><?php _e('Back home','m_n'); ?></a>
	 	  <?php /* If this is a daily archive */ } elseif (is_day()) { ?>
			<p class="string"><?php _e('Archive of published articles on','m_n'); ?> <?php the_time('F jS, Y'); ?></p>
			<a href="<?php echo get_option('home'); ?>/" class="back"><?php _e('Back home','m_n'); ?></a>
		 <?php /* If this is a monthly archive */ } elseif (is_month()) { ?>
			<p class="string"><?php _e('Archive of published posts on','m_n'); ?> <strong><?php the_time('F, Y'); ?></strong></p>
			<a href="<?php echo get_option('home'); ?>/" class="back"><?php _e('Back home','m_n'); ?></a>
			<?php /* If this is a yearly archive */ } elseif (is_year()) { ?>
			<p class="string"><?php _e('Archive of published posts on','m_n'); ?> <strong><?php the_time('Y'); ?></strong></p>
			<a href="<?php echo get_option('home'); ?>/" class="back"><?php _e('Back home','m_n'); ?></a>
		  <?php /* If this is an author archive */ } elseif (is_author()) { ?>
			<p class="string"><?php _e('Archive of published posts by ','m_n'); ?></p>
			<a href="<?php echo get_option('home'); ?>/" class="back"><?php _e('Back home','m_n'); ?></a>
